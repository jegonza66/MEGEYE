...
mysurf = load('canonical_surf_MNI');
...
save('ventral_occ_tempgrid','reducedgrid','relevantgridpts','redundantgridpts');
...
save('ventral_occ_tempgrid_413','reducedgrid','relevantgridpts','redundantgridpts');
